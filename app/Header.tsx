...
export default function Header() {
  ...
  return (
    <header className={`site-header${open ? " nav-open" : ""}`}>
      ...
      <a className="pill dark desktop-cta" href="https://maps.app.goo.gl/3tkZgS4eCXT8eLjU6" target="_blank" rel="noreferrer"><MapPinned size={18} aria-hidden="true" /> Cómo llegar</a>
